...
<!-- Modal Add Produk-->
<form id="add-row-form" action="<?php echo base_url() . 'index.php/product/save' ?>" method="post">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <input type="text" name="code" class="form-control" placeholder="Kode Barang" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <select name="category" class="form-control" placeholder="Kode Barang" required>
...
<!-- Modal Update Produk-->
<form id="add-row-form" action="<?php echo base_url() . 'index.php/product/update' ?>" method="post">
...
<!-- Modal Hapus Produk-->
<form id="add-row-form" action="<?php echo base_url() . 'index.php/product/delete' ?>" method="post">
