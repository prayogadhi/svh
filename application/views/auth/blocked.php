...
<body class="fixed-header error-page">
    <div class="d-flex justify-content-center full-height full-width align-items-center">
        <div class="error-container text-center">
            ...
            <h2 class="semi-bold">Access Forbidden!</h2>
            <p class="p-b-10">This page you are looking for does not exsist for you.</a>
            </p>
            <div class="error-container-innner text-center">
                <h3><a href="javascript:history.back()"><i class="fa fa-arrow-left"></i> Go Back</a></h3>
            </div>
        </div>
    </div>
    ...
    <script src="<?= base_url('vendor/'); ?>assets/plugins/bootstrap/js/bootstrap.min.js" type="text/javascript"></script>
    <script src="<?= base_url('vendor/'); ?>assets/plugins/jquery/jquery-easy.js" type="text/javascript"></script>
    <script src="<?= base_url('vendor/'); ?>assets/plugins/jquery-unveil/jquery.unveil.min.js" type="text/javascript"></script>
    ...
    <script type="text/javascript" src="<?= base_url('vendor/'); ?>assets/plugins/select2/js/select2.full.min.js"></script>
    <script type="text/javascript" src="<?= base_url('vendor/'); ?>assets/plugins/classie/classie.js"></script>
    <script src="<?= base_url('vendor/'); ?>assets/plugins/switchery/js/switchery.min.js" type="text/javascript"></script>
    <!-- END VENDOR JS -->
