                ...
                <table class="table table-hover table-responsive-block" id="product_table">
                    <thead>
                        <tr>
                            ...
                            <th style="width: 21.5%">Phone</th>
                            <th style="width: 21.5%">Email</th>
        ...
        <div class="modal-content-wrapper">
            <div class="modal-content">
                <div class="modal-header clearfix text-left">
                    ...
                    <h5>Add <span class="semi-bold">Customer</span></h5>
                    <!-- <p class="p-b-10">We need payment information inorder to process your order</p> -->
                </div>

                <form method="post" action="<?php echo base_url() . 'customer/add_customer' ?>">
                    <div class="modal-body">
                        ...
                        <div class="row clearfix">
                            ...
                            <div class="col-md-6">
                                <div class="form-group form-group-default">
                                    <label>Email</label>
                                    <input type="text" name="email" class="form-control" placeholder="ex: some@example.com" required>
                                </div>
                            </div>
                        </div>
                        <div class="form-group form-group-default">
            ...
            <div class="modal-content-wrapper">
                <div class="modal-content">
                    <div class="modal-header clearfix text-left">
                        ...
                        <h5>Edit <span class="semi-bold">Customer</span></h5>
                    </div>
    ...
    <div id="modalHapusPelanggan<?= $id ?>" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="largeModal" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form class="form-horizontal" method="post" action="<?php echo base_url() . 'customer/delete_customer' ?>">
                    <div class="modal-body">
                        <p>Are you sure?</p>
                        <input name="cust_id" type="hidden" value="<?= $id; ?>">
                    </div>
