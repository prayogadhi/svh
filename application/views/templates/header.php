...
<head>
    ...
    <link media="screen" type="text/css" rel="stylesheet" href="<?= base_url('vendor/'); ?>assets/plugins/bootstrap-datepicker/css/datepicker3.css">
    <link href="<?= base_url('vendor/'); ?>assets/plugins/bootstrap-daterangepicker/daterangepicker-bs3.css" rel="stylesheet" type="text/css" media="screen">
    <link href="<?= base_url('vendor/'); ?>assets/plugins/bootstrap-timepicker/bootstrap-timepicker.min.css" rel="stylesheet" type="text/css" media="screen">
    <!-- datatables -->
    <link href="<?= base_url('vendor/'); ?>assets/plugins/jquery-datatable/media/css/dataTables.bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="<?= base_url('vendor/'); ?>assets/plugins/jquery-datatable/extensions/FixedColumns/css/dataTables.fixedColumns.min.css" rel="stylesheet" type="text/css" />
    <link href="<?= base_url('vendor/'); ?>assets/plugins/datatables-responsive/css/datatables.responsive.css" rel="stylesheet" type="text/css" media="screen" />
